            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="gender_id" class="col-md-4 col-form-label text-md-right">{{ __('جنسیت') }}</label>

                            <div class="col-md-6">
                                <select name="gender_id" >

                                    @foreach ($Temp['genders'] as $gender)
                                        <option value="{{$gender->id}}">{{$gender->persian_name}}</option> 
                                    @endforeach
